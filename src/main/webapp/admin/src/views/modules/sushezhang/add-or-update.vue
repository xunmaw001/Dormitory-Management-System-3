          ...
          <el-form-item class="input" label="宿舍长账号" prop="sushezhangzhanghao">
              <el-input v-model="ruleForm.sushezhangzhanghao" 
                placeholder="宿舍长账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍长姓名" prop="sushezhangxingming">
          <el-input v-model="ruleForm.sushezhangxingming" 
              placeholder="宿舍长姓名" clearable  :readonly="ro.sushezhangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍长姓名" prop="sushezhangxingming">
              <el-input v-model="ruleForm.sushezhangxingming" 
                placeholder="宿舍长姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
            ...
            ruleForm: {
                	        sushezhangzhanghao: '',
                                ...
                                sushehaoOptions: [],
                                                rules: {
                  sushezhangzhanghao: [
                            { required: true, message: '宿舍长账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  sushezhangxingming: [
                            { required: true, message: '宿舍长姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sushezhangzhanghao = true;
            continue;
	            	            ...
	            	            if(o=='sushezhangxingming'){
            this.ruleForm.sushezhangxingming = obj[o];
	    this.ro.sushezhangxingming = true;
            continue;
          }
	            	            if(o=='mima'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `sushezhang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.sushezhangCrossAddOrUpdateFlag = false;
                  this.parent.search();
