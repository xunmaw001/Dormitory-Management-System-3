              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jibenqingkuang" label="基本情况" prop="jibenqingkuang">
                    <span>{{ruleForm.jibenqingkuang}}</span>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="存在问题" prop="cunzaiwenti">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.cunzaiwenti" label="存在问题" prop="cunzaiwenti">
                    <span v-html="ruleForm.cunzaiwenti"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="几点要求" prop="jidianyaoqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jidianyaoqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jidianyaoqiu" label="几点要求" prop="jidianyaoqiu">
                    <span v-html="ruleForm.jidianyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cunzaiwenti = true;
            continue;
	            	            ...
	            	            if(o=='jidianyaoqiu'){
            this.ruleForm.jidianyaoqiu = obj[o];
	    this.ro.jidianyaoqiu = true;
            continue;
          }
	            	            if(o=='fengmian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `weishengtongbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weishengtongbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
