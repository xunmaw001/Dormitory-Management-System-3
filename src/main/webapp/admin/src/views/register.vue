  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">寝室管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
																														...
																														<!-- <div v-if="tableName=='sushezhang'" class="input-group">
			   <div class="label">宿舍长账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.sushezhangzhanghao" class="input" type="text" placeholder="宿舍长账号">
			   </div>
			 </div> -->
			<el-form-item label="宿舍长账号" class="input" v-if="tableName=='sushezhang'">
			  <el-input v-model="ruleForm.sushezhangzhanghao" autocomplete="off" placeholder="宿舍长账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='sushezhang'" class="input-group">
			   <div class="label">宿舍长姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.sushezhangxingming" class="input" type="text" placeholder="宿舍长姓名">
			   </div>
			 </div> -->
			<el-form-item label="宿舍长姓名" class="input" v-if="tableName=='sushezhang'">
			  <el-input v-model="ruleForm.sushezhangxingming" autocomplete="off" placeholder="宿舍长姓名" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='sushezhang'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='sushezhang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='sushezhang'" class="input-group">
			   <div class="label">联系电话</div>
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='sushezhang'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='sushezhang'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='sushezhang'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                    ...
                                    if((!this.ruleForm.lianxidianhua) && `xuesheng` == this.tableName){
        this.$message.error(`联系电话不能为空`);
        return
      }
                                                                                                if((!this.ruleForm.sushezhangzhanghao) && `sushezhang` == this.tableName){
        this.$message.error(`宿舍长账号不能为空`);
        return
      }
                                                            if((!this.ruleForm.sushezhangxingming) && `sushezhang` == this.tableName){
        this.$message.error(`宿舍长姓名不能为空`);
        return
      }
                                                            if((!this.ruleForm.mima) && `sushezhang` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                    if(`sushezhang` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
                                                                                                                                                      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201210/a190c1e95e7c418bb89809f87bd8c3de.jpg");
		height: 100vh;
